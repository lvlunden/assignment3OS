...
//HOW TO COMPILE AQ_SEQ.C INTO AN OBJECT FILE:
/*
 * Use the command: gcc -c aq_seq.c -o aq_seq.o
 */


//HOW TO CREATE THE STATIC LIBRARY
/*
 * Use the command: ar rcs libaq.a aq_seq.o
 */

//HOW TO LINK OUR STATIC LIBRARY TO OTHER PROGRAMS
/*
 * Use the command: gcc test_program.c -L. -laq -o test_program
 */